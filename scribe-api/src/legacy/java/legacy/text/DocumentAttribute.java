...
public class DocumentAttribute<S, T> implements Serializable {
  ...
  public final BiConsumer<Document<? extends AbstractDocument>, T> setter;

  protected DocumentAttribute(String name, Class<T> type) {
    this(name, type, (x, y) -> {});
  }

  protected DocumentAttribute(String name, Class<T> type, BiConsumer<Document<? extends AbstractDocument>, T> setter) {
    this.name = name;
    this.type = type;
    this.setter = setter;
  }
  ...
  public static <S, T> DocumentAttribute<S, T> specialized(String name, Class<T> type, BiConsumer<Document<? extends AbstractDocument>, T> setter) {
