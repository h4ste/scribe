...
//
//  abstract public T getAnnotations(S annotation);
//
...
//
//      @Override
//      public T getAnnotations(S annotation) {
//        final int id = (int) annotation.asGate().getFeatures().getAnnotations(name);
//        final Document<?> doc = annotation.getDocument();
//
//        return doc.getAnnotationById(id, type).getAnnotations();
//      }
//    };
//  }
//
...
//      throw new UnsupportedOperationException("Cannot annotate typed attribute for annotation. Use AnnotationType instead.");
//    }
//
//    return new AnnotationAttribute<S, T>(name) {
//      @Override
...
//      @Override
//      public T getAnnotations(S annotation) {
//        return type.cast(annotation.asGate().getFeatures().getAnnotations(name));
//      }
//    };
//  }
//
...
//
//        @Override
//        public C getAnnotations(S annotation) {
//          try {
//            final C clazz = Unsafe.cast(collectionClass.newInstance());
//            final int[] ids = Unsafe.cast(annotation.asGate().getFeatures().getAnnotations(name));
//            final Document<?> doc = annotation.getDocument();
//            for (int id : ids) {
//              final gate.Annotation gateAnn = doc.getUnsafeAnnotationById(id).getAnnotations().asGate();
...
//        @Override
//        public C getAnnotations(S annotation) {
//          return Unsafe.cast(collectionClass.cast(annotation.asGate().getFeatures().getAnnotations(name)));
//        }
//      };
//    }
//  }
