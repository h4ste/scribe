 ...
 */
public class UnsafeAnnotation extends AbstractAnnotation<UnsafeAnnotation> implements Iterable<Map.Entry<String, Object>>, HasAttributes {
...
//    try {
//      final AnnotationView annSet = doc.asGate().getAnnotations(annotationSet);
