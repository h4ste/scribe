...
public interface AnnotationType<T extends Annotation<T>> /* extends TypesafeMap.Key<T> */ {
   ...
   * @param parent Document to annotate the annotation on
...
//        annotation.set(Annotation.id, annotation.getDocument().registerAnnotation(annotation));
  ...
  /**
   * Constructs a new Annotation on the given Document across the given character offsets beloneing to the given AnnotationView
   *
   * @param parent Document to annotate the annotation on
