...
//import com.github.h4ste.scribe.legacy.text.annotation.Entity;
//import com.github.h4ste.scribe.legacy.text.annotation.PhraseChunk;
...
//public class GeniaAnnotator<D extends AbstractDocument> implements Annotator<D> {
...
//   */
//  public static <D extends AbstractDocument> GeniaAnnotator<D> sentenceAnnotator(final boolean clear) {
...
//   */
//  public static <D extends AbstractDocument> GeniaAnnotator<D> sentenceAndTokenAnnotator(final boolean clear) {
...
//   */
//  public static <D extends AbstractDocument> GeniaAnnotator<D> tokenAnnotator(Function<Document<? extends D>, ? extends Iterable<Sentence>> sentenceProvider, final boolean clear) {
...
//  }
//
//  public static class Builder<D extends AbstractDocument> extends Annotator.Builder<D,Builder<D>> {
...
//              document.get(AbstractDocument.id));
...
//        } else {
//          log.warn("Document {} already has GENIA annotations", document.get(AbstractDocument.id));
//        }
//      }
//
//      // Skip if needed
//      if (!document.get(ANNOTATION_SET_NAME, Token.TYPE).isEmpty()) {
//        log.warn("Skipping document {} as it already has GENIA tokens", document.get(AbstractDocument.id));
//      }
//      else {
//        // Otherwise, add stuff
//        log.trace("Annotating GENIA tokens, chunks, & entities on {}", document.get(AbstractDocument.id));
