...
import com.github.h4ste.scribe.legacy.text.annotation.AbstractAnnotation;
...
import com.github.h4ste.scribe.legacy.text.relation.DependencyGraph;
import com.github.h4ste.scribe.legacy.text.relation.OpenRelation;

/**
 * Created by travis on 9/3/15.
 */
public class StanfordOpenIEAnnotator<D extends AbstractDocument> implements Annotator<D> {
  ...
  public <B extends D> void annotate(Document<B> document) {
    ...
    for (int si = 0; si < sentences.size(); si++) {
      ...
      for (int ti = 0; ti < tokens.size(); ti++) {
        ...
        stanfordToken.setDocID(document.get(AbstractDocument.id));
