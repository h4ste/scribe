...
import com.github.h4ste.scribe.legacy.text.DuplicateAnnotationException;
import edu.utdallas.hltri.scribe.text.annotation.*;

import com.github.h4ste.scribe.legacy.text.annotation.Annotation;
import com.github.h4ste.scribe.legacy.text.annotation.Chunk;
import com.github.h4ste.scribe.legacy.text.annotation.CorefMention;
import com.github.h4ste.scribe.legacy.text.annotation.Sentence;
import com.github.h4ste.scribe.legacy.text.annotation.Timex3;
import com.github.h4ste.scribe.legacy.text.annotation.Token;
import com.github.h4ste.scribe.legacy.text.relation.Dependency;
import com.github.h4ste.scribe.legacy.text.relation.OpenRelation;
 ...
 * @author bryan
 */
public class StanfordCoreAnnotator<D extends AbstractDocument> implements Annotator<D> {
...
//        if (ner) {
//          final String neLabel = stanfordToken.getAnnotations(CoreAnnotations.NamedEntityTagAnnotation.class);
...
//                .longValue();
          ...
          for (final RelationTriple stanfordRelation : stanfordRelations) {
            ...
            for (final CoreLabel cl : stanfordRelation.relation) {
              ...
              if (tokens.get(cl.index() - 1) == null) {
                System.out.printf("Doc %s: relation - [%s]\nBad token: %s.\nSentence length: %d", document.get(AbstractDocument.id),
    ...
    if (coref) {
      ...
      if (chains == null) {
        log.warn("No coref annotations in doc {}", document.get(AbstractDocument.id));
      }
      else {
