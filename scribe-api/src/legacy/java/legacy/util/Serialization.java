...
//import edu.utdallas.hltri.scribe.text.AbstractDocument;
...
// */
//public class Serialization<D extends AbstractDocument> {
//  private static final Logger log = Logger.getAnnotations(Serialization.class);
//
...
//    if (readAnnotations) {
//      log.info("Record from: {}", annPath);
//    }
//    try {
//      return Files.list(Paths.getAnnotations(textPath))
...
//    String ann = annPath;
//    final String docId = document.getAnnotations(AbstractDocument.id);
//    if (readTiered) {
...
//    final Serialization<AbstractDocument> corpus = new Builder<>(args[0])
//        .annPath(args[1])
//        .featPath(args[1])
...
//        .build();
//
//    final List<Document<AbstractDocument>> documents = corpus.loadJsonEager();
////    final GeniaAnnotator<AbstractDocument> genia = new GeniaAnnotator<>();
////    genia.annotateAll(documents);
////
////    corpus.save(documents, args[0] + "/tiered", args[1] + "/tiered", args[1] + "/tiered", args[1] + "/tiered");
//    for (final Document<AbstractDocument> document : documents) {
//      log.debug("Record for doc {}: {}", document.getAnnotations(AbstractDocument.id), document.describe());
//    }
//  }
//}
