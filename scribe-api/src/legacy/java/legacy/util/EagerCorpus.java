...
public class EagerCorpus {
  ...
  public <T extends AbstractDocument> List<Document<T>> fromDataStore(final String file) {
    return fromDataStore(new File(file));
  }

  public <T extends AbstractDocument> List<Document<T>> fromDataStore(final File file) {
    GateUtils.init();
